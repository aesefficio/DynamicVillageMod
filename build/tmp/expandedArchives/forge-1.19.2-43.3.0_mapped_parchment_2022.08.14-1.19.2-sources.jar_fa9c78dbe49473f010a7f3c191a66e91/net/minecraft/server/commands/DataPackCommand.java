...
public class DataPackCommand {
   ...
   private static int listAvailablePacks(CommandSourceStack pSource) {
      ...
      if (list.isEmpty()) {
         ...
         pSource.sendSuccess(Component.translatable("commands.datapack.list.available.success", list.size(), ComponentUtils.formatList(list, (p_136844_) -> {
   ...
   private static int listEnabledPacks(CommandSourceStack pSource) {
      ...
      if (collection.isEmpty()) {
         ...
         pSource.sendSuccess(Component.translatable("commands.datapack.list.enabled.success", collection.size(), ComponentUtils.formatList(collection, (p_136807_) -> {
