...
public class StructureTagsProvider extends TagsProvider<Structure> {
   ...
   @Deprecated
   public StructureTagsProvider(DataGenerator pGenerator) {
      super(pGenerator, BuiltinRegistries.STRUCTURES);
   }
   public StructureTagsProvider(DataGenerator pGenerator, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
      super(pGenerator, BuiltinRegistries.STRUCTURES, modId, existingFileHelper);
   }
