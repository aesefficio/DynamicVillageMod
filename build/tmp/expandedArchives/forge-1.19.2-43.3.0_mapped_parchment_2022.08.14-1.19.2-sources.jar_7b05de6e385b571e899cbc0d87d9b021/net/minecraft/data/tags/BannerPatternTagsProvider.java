...
public class BannerPatternTagsProvider extends TagsProvider<BannerPattern> {
   ...
   @Deprecated
   public BannerPatternTagsProvider(DataGenerator pGenerator) {
      super(pGenerator, Registry.BANNER_PATTERN);
   }
   public BannerPatternTagsProvider(DataGenerator pGenerator, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
      super(pGenerator, Registry.BANNER_PATTERN, modId, existingFileHelper);
   }
