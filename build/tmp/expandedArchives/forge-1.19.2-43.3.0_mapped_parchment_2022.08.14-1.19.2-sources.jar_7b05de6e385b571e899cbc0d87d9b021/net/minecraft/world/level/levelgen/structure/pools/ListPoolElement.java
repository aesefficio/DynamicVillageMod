...
public class ListPoolElement extends StructurePoolElement {
   ...
   public BoundingBox getBoundingBox(StructureTemplateManager pStructureTemplateManager, BlockPos p_227287_, Rotation pRotation) {
      Stream<BoundingBox> stream = this.elements.stream().filter((p_210371_) -> {
         return p_210371_ != EmptyPoolElement.INSTANCE;
      }).map((p_227298_) -> {
         return p_227298_.getBoundingBox(pStructureTemplateManager, p_227287_, pRotation);
      });
