...
public class TadpoleAi {
   ...
   private static void initIdleActivity(Brain<Tadpole> pBrain) {
      pBrain.addActivity(Activity.IDLE, ImmutableList.of(Pair.of(0, new RunSometimes<>(new SetEntityLookTarget(EntityType.PLAYER, 6.0F), UniformInt.of(30, 60))), Pair.of(1, new FollowTemptation((p_218740_) -> {
         return 1.25F;
