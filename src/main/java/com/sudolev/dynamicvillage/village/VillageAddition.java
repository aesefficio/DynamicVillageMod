...
public class VillageAddition {
   ...
   private static final List<ResourceLocation> DECOR_POOLS = List.of(
      new ResourceLocation("minecraft:village/plains/decor"),
      new ResourceLocation("minecraft:village/desert/decor"),
      new ResourceLocation("minecraft:village/savanna/decor"),
      new ResourceLocation("minecraft:village/snowy/decor"),
