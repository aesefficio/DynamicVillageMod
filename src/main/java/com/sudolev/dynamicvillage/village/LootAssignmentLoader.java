...
public class LootAssignmentLoader extends SimpleJsonResourceReloadListener {
   ...
   private static void warnIfLootTableMissing(ResourceManager resourceManager, ResourceLocation file, ResourceLocation lootTable) {
      ResourceLocation singular = ResourceLocation.fromNamespaceAndPath(lootTable.getNamespace(), "loot_table/" + lootTable.getPath() + ".json");
      ResourceLocation plural = ResourceLocation.fromNamespaceAndPath(lootTable.getNamespace(), "loot_tables/" + lootTable.getPath() + ".json");
