...
public record VillageTradeEntry(
    ...
    */
   public record TradeItem(Optional<ResourceLocation> item, Optional<ResourceLocation> tag, CountRange count, Optional<DataComponentPatch> components) {
      public static final Codec<TradeItem> CODEC = RecordCodecBuilder.create(
         instance -> instance.group(
               ...
               DataComponentPatch.CODEC.optionalFieldOf("components").forGetter(TradeItem::components)
            )
